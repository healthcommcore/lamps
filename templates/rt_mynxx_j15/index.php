...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-23342460-1']);
  ...
  (function() {
	...
	<body id="ff-<?php echo $fontfamily; ?>" class="<?php echo $fontstyle; ?> <?php echo $tstyle; ?> <?php echo $body_style; ?> iehandle">
    	<a href="<?php echo $doc . '#content'; ?>" class="hide">Skip to content</a>
		<div id="page-bg">
			<!--Begin Header-->
			<div id="header">
				<div class="wrapper">
				...
				<div id="main-body">
					...
					<div id="botbar"><div id="botbar2"><div id="botbar3">
						<?php if ($this->countModules('popup')) : ?>
							<div id="ql-button"><a href="#" class="ql-button-desc" rel="rokbox[400 300][module=popup]"><?php echo JText::_('MORE_INFO'); ?></a></div>
						<?php endif; ?>
